...
const diffCars = generateCars(10);
console.log(diffCars);

const speed = diffCars.filter (car =>{return car.speed >= 30 && car.speed <=60});

console.log(speed);

const color = diffCars.filter (car =>{return car.speed != "lightyellow"});

console.log(color);


const DanskSprog = diffCars.map(car => {
    const danishObj={
    maerke:car.make,
    farve:car.color,
    fart:car.speed
